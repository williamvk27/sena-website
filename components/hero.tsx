          ...
          <AnimateOnScroll animation="fadeInLeft" delay={200}>
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Mais de 8 anos de experiência oferecendo tecnologia de ponta para museus, hospitais, indústrias e
                diversos segmentos.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-teal-600 hover:bg-teal-700 hover:scale-105 transition-all duration-300">
                  Solicitar Orçamento
