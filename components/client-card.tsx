  ...
  return (
    <div className="bg-white rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 overflow-hidden">
      <div className="p-6">
        {/* Badge do setor */}
        <div className="mb-4">
          <span className={`inline-block px-3 py-1 text-sm font-medium rounded-full ${getSectorColor(sector)}`}>
            {sector}
          </span>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-bold text-gray-900 mb-2 leading-tight">{name}</h3>
